...
- Mount credentials secret to the reverse-proxy and not get the reverse-proxy pulling it from k8s API. ([#1614](https://github.com/dell/csm/issues/1614))
- Allow to install on K8s cluster connected to multiple PowerFlex systems. ([#1613](https://github.com/dell/csm/issues/1613))
